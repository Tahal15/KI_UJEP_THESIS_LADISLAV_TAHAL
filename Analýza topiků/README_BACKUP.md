...
Ve složce se nachází dva výsledné soubory:

| Soubor | Popis |
|:---------------------------|:---------------------------------------------------------------|
| **`topic100.xlsx`** | Seskupení témat s **100 % Jaccardovou podobností** (identická struktura JSON) |
| **`topic50.xlsx`** | Seskupení témat s **≥ 50 % podobností** (částečně podobná struktura) |
