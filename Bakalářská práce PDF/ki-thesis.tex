...
\begin{figure}[h]
  ...
  \caption{Cloudové řešení MS data platform - převzato z \protect\cite{azure_data_warehousing}}
...
\begin{figure}[h]
  ...
  \caption{Cloudové řešení Google Cloud Data Analytics - převzato z \protect\cite{google_data_products}}
